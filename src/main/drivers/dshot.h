...
typedef enum dshotTelemetryType_e {
	...
	DSHOT_TELEMETRY_TYPE_UNUSED0 		= 2,
	DSHOT_TELEMETRY_TYPE_UNUSED1 		= 3,
	DSHOT_TELEMETRY_TYPE_UNUSED2 		= 4,
	DSHOT_TELEMETRY_TYPE_UNUSED3 		= 5,
	DSHOT_TELEMETRY_TYPE_DEBUG0 		= 6,
	DSHOT_TELEMETRY_TYPE_DEBUG1 		= 7,
